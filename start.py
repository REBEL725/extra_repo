...
async def start(event):
    ...
    vent = event.chat_id
    starttext = f"Hello, {firstname} ! Nice To Meet You, Well I Am {bot_id}, An Powerfull Assistant Bot. \n\nMy [➤ Master](tg://user?id={bot.uid}) \nYou Can Talk/Contact My Master Using This Bot. \n\nIf You Want Your Own Assistant You Can Deploy From Button Be     low. \n\nPowered by    ➪ [✰ᖇᗴᗷᗴᒪᗷOT](https://t.me/REBEL_BOT_CHATING)"
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Help Me ❓", "https://t.me/REBEL_BOT_CHATING")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy 『𝐑𝐄𝐁𝐄𝐋𝐁𝐎𝐓』 In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [Button.url("Tutorial 📺", "https://youtu.be/zY08-hFD7oM")],
                [Button.url("Need Help ❓", "https://t.me/REBEL_BOT_CHATING")],
            ],
        )
